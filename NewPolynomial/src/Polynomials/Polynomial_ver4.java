...
//          System.out.println("addTermed -0.9: |" + strPoly +"|");
          ...
          String strPolyTwo = polyTwo.toString();
          System.out.println("New polyTwo: |" + strPolyTwo +"|");
          
          Monomial monomial_11 = new Monomial(1,1.1);
          polyTwo.addTerm(monomial_11);
          strPolyTwo = polyTwo.toString();
          System.out.println("addTermed 1.1x: |" + strPolyTwo +"|");
          
          Monomial monomial_51 = new Monomial (5, 5.5);
          polyTwo.addTerm(monomial_51);
          strPolyTwo = polyTwo.toString();
          System.out.println("addTermed 5.5x^5: |" + strPolyTwo +"|");
          
          Monomial monomial_31 = new Monomial(3,3.3);
          polyTwo.addTerm(monomial_31);
          strPolyTwo = polyTwo.toString();
          System.out.println("addTermed 3.3x^3: |" + strPolyTwo +"|");
          
          Monomial monomial_01 = new Monomial(0,0.5);
          polyTwo.addTerm(monomial_01);
          strPolyTwo = polyTwo.toString();
          System.out.println("addTermed 0.5: |" + strPolyTwo +"|");
          
          System.out.println();
          polyTwo.addPolynomial(polynomial);
          System.out.println("Added PolyTwo and polynomial.");
